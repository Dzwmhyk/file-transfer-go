                                        ...
                                        <div className="ml-8 mt-1 space-y-1">
                                            {section.children.map((child) => (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-md text-left transition-colors ${activeSection === child.id
                            ...
                            <div className="scroll-mt-20" id="docker-deployment">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <CodeBlock code={`git clone https://github.com/Dzwmhyk/file-transfer-go.git
cd file-transfer-go
docker-compose up -d`} />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <CodeBlock code={`docker run -d -p 8080:8080 --name file-transfer-go Dzwmhyk/file-transfer-go:latest`} />
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p className="text-gray-700 mb-3">
                                            前往 <a
                                                href="https://github.com/Dzwmhyk/file-transfer-go/releases/"
                    ...
                    <Section id="port-config" title="端口配置" icon={<Settings className="w-6 h-6 text-blue-600" />}>
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <CodeBlock code="docker run -d -p 18080:8080 Dzwmhyk/file-transfer-go:latest" />
                            </div>
                                    ...
                                    <div className="flex-shrink-0">
                                        <div className="bg-gray-50 rounded-lg p-4 text-center">
                                            <iframe
                                                ...
                                                allowFullScreen
                                            ></iframe>
                                            <p className="text-sm text-gray-600 mt-2">注册辙隙加入交流群</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
